...
Il risultato è un'immagine in cui lo sfondo è indistinguibile dal cui disco solare (esso stesso in scala di grigi), introducendo rumore e rendendo inefficace l'addestramento, come si può constatare chiaramente nella figura~\ref{fig:artefatto_grigio}.
\begin{figure}[H]
  \centering
