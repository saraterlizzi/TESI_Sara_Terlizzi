...
\end{itemize}
Per cui, è riduttivo dire che essi siano stati l'oggetto della tesi: sono stati fonte di "verità" per il progetto. Sono stati utilizzati per creare il dataset annotato, indispensabile per addestrare il modello YOLOv7 a riconoscere queste strutture automaticamente.
