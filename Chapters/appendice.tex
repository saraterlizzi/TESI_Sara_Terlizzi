...
\begin{lstlisting}[language=Python, caption={Script di tracciamento}, label={lst:track_script}]
...
\begin{lstlisting}[language=Python, caption={Script per il calcolo delle metriche MOT}, label={lst:track_metrics}]
